...
**Quick summary** — routine execution, no decisions or surprises. One paragraph: "What happened. Anything surprising: [yes/no]. Lesson: [one line or none]." Append to `project-log.md` and move on.
...
5. **Recurring?** First time, or seen before? Check `project-log.md` for history.
...
Status: ESCALATED — requires GoT analysis against project-log.md
```
